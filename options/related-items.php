...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" id="related_items_above" ?>> <label for="related_items_above"><?php I18n::_e('above the content') ?></label><?php MockingBird::printProNotice('unlock') ?><br>
            <input type="radio" id="related_items_none" ?>> <label for="related_items_none"><?php printf(I18n::__('Do not show related %s.'), PostTypeLabels::getItemPluralName()) ?></label><?php MockingBird::printProNotice('unlock') ?>
