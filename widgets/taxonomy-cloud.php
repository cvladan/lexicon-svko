...
class Taxonomy_Cloud_Widget extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            ...
            sprintf(I18n::__('%s Taxonomy Cloud'), PostTypeLabels::getItemDashboardName()),
    ...
    public function Form($options): void
    {
        ...
        <p>
            ...
            <select id="<?php echo $this->get_Field_Id('taxonomy') ?>" name="<?php echo $this->get_Field_Name('taxonomy') ?>" class="widefat">
                <?php foreach (get_Object_Taxonomies(PostType::getPostTypeName()) as $taxonomy) : $taxonomy = get_Taxonomy($taxonomy) ?>
