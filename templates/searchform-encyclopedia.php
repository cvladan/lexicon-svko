...
use SVKO\Lexicon\I18n;
use SVKO\Lexicon\PostType;

$permalink_structure = get_Option('permalink_structure');
$search_url = get_Post_Type_Archive_Link(PostType::getPostTypeName());
...
<form role="search" method="get" class="encyclopedia search-form" action="<?php echo esc_URL($search_url) ?>">
    <?php if (empty($permalink_structure)) : ?>
        <input type="hidden" name="post_type" value="<?php echo PostType::getPostTypeName() ?>">
    <?php endif ?>
